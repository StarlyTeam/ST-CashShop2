...
public class STSoundImpl implements STSound {
    ...
    @Override public void playSound(Player player) { function.play(player); }
    @Override public boolean isEmpty() { return function.isEmpty(); }
    ...
    private static class SoundFunction {
        ...
        private boolean isEmpty() { return !root && (next == null || data.isEmpty()); }
